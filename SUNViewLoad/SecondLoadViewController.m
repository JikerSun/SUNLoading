...
@interface SecondLoadViewController ()

@end

@implementation SecondLoadViewController
{UIWebView *webView;}
- (void)viewDidLoad {
    [super viewDidLoad];
//    [self addWebView];
...
{
    NSLog(@"左滑动响应喽");
    ThirdLoadViewController *thVC=[[ThirdLoadViewController alloc]init];
    thVC.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
